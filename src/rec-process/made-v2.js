...
const myNumberGenerator1 = new NumberGenerator(
  '8, 1, 2, 5, 6, 8, 9, 5, 6, 17, 22, 55, 5'
)
const myNumberGenerator2 = new NumberGenerator(
  '1, 4, 10, 11, 10, 12, 16, 18, 22, 24, 122'
)
const myNumberGenerator3 = new NumberGenerator(
  '1, 500, 400, 500, 12, 1, 1, 122, 122, 122, 122'
)
