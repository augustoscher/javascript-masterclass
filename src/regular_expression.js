...
// 2. Useful Regex Supporting API methods
// String.match(pattern):
// It Tries to match the pattern on the target string.
// This method returns null if none (or an array) is found.

// If you are applying the global flag to the expression, the content of the array will be all the captured occurrences;
// if not, the array will contain a single match along with additional information about the captured value, such as its index, groups, and the targeted string.

const r = sentence.match(thePattern)
console.log(r);
console.log('string founded in sentence: ', r[0]);
